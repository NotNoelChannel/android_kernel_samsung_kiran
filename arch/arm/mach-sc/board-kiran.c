...
extern void __init dev_bluetooth_init(void);
#endif
...
static struct battery_data_t samsung_battery_data[] = {0,};
...
static struct platform_device bcm47520_gps = {
	.name	= "bcm47520",
	.id	= -1,
};
...
static void __init sc8830_init_machine(void)
{
	...
	strlcpy(utsname()->nodename, machine_desc->name,
	...
	platform_device_register(&bcm47520_gps);
}
