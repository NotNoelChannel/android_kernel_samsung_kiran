...
/* Base SPRD Regulator map is located in arch\arm\mach-sc\include\mach\__sc8830_regulator_map.h */

/* Base addresses of the registers are located in arch\arm\mach-sc\include\mach\sci_glb_regs.h */
/* More information on the registers in SPRD Spec [Page 2266] */
...
/* Clocks for SPRD located in arch\arm\mach-sc\include\mach\__clock_tree.h */

/*#DEFINE ***  Add rest of the clocks here */

static struct clk_gate_mask clk_gate_masks[] = {
	/* System Related Clocks, Start */
	/* AHB EB */
	{"BUSMON2_EB", CLK_MON_AHB_EB, 16},
	{"MUSMON1_EB", CLK_MON_AHB_EB, 15},
	{"MUSMON0_EB", CLK_MON_AHB_EB, 14},
	...
	{"AP_EMC_AUTO_GATE_EN",  CLK_MON_AP_SYS_AUTO_SLEEP_CFG, 4},
	{"CA7_EMC_AUTO_GATE_EN",  CLK_MON_AP_SYS_AUTO_SLEEP_CFG, 3},
	...
	{"PD_CP0_L1RAM_STATE",  CLK_MON_PWR_STATUS1_DBG, 26},
...
MODULE_AUTHOR("Diwas Kumar <diwas.kumar@samsung.com> ; Himanshu Sheth <himanshu.s@samsung.com>");
