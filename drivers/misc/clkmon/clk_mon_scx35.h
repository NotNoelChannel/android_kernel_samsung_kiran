 ...
 *
 * Register address based on scx15 Chipset
 */
...
#define CLK_MON_PWR_STATUS1_DBG	REG_PMU_APB_PWR_STATUS1_DBG
#define CLK_MON_PWR_STATUS2_DBG	REG_PMU_APB_PWR_STATUS2_DBG
#define CLK_MON_PWR_STATUS3_DBG	REG_PMU_APB_PWR_STATUS3_DBG
