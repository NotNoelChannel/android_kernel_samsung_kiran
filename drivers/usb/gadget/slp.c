		  ...
		  struct usb_composite_dev *cdev)
{
	...
	/* 
	 * Issue	: P141008-02425
	 * Problem	: During usb insert "CDC-ACM" error popup in win-xp and vista
	 * Details	: CDC-ACM with serialport interfaceprotocol(0xFF) wont be 
	 *				supported in XP and Vista PC's. But for Nvitem restoring
	 *				and other SPRD modem tools needs this feature in 
