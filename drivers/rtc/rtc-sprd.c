...
#define RTC_INT_ALM_MSK (RTC_SEC_BIT | RTC_MIN_BIT | RTC_HOUR_BIT | RTC_DAY_BIT | RTC_ALARM_BIT)
...
static int __init sprd_rtc_init(void)
{
	...
	wake_lock_init(&rtc_interrupt_wake_lock,
		WAKE_LOCK_SUSPEND, "sprd-rtc_interrupt");
