...
typedef	int32_t (*mipi_write_t)(uint8_t data_type, uint8_t *param, uint16_t param_length);
...
struct ops_mipi{
	...
	int32_t (*mipi_write)(uint8_t data_type, uint8_t *param, uint16_t param_length);
