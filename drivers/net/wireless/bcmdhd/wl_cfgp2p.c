...
wl_cfgp2p_init_discovery(struct bcm_cfg80211 *cfg)
{
	...
	printf("%s index = %d\n", __FUNCTION__, wl_to_p2p_bss_bssidx(cfg, P2PAPI_BSSCFG_DEVICE));
...
#if 0//defined(CUSTOMER_HW4) && defined(PLATFORM_SLP)
	g_if_flag |= 0x2;
