...
#define FM_CHECK_SEND_CMD_STATUS(ret)  \
    if (ret < 0) {\
	pr_err("(fmdrv) %s() FM_CMD_STATUS failed %d\n", __func__, ret);\
        return ret;\
    }
...
/* Mute modes */
#define    FM_MUTE_OFF         0    /* darrel issue 02 : FM mute define fix*/ 
#define    FM_MUTE_ON          1
...
/* COS value */
#define FM_RX_COS_MAX      127
#define FM_RX_COS_MIN      -128
#define FM_RX_COS_DEFAULT  18
