...
#define     FM_START_SNR_MIN        0
#define     FM_START_SNR_MAX        63

#define     FM_STOP_SNR_MIN         0
#define     FM_STOP_SNR_MAX         63
/* minimum and maximum value of start/stop RSSI for stereo/mono blend */
#define     FM_START_RSSI_MIN       -128
#define     FM_START_RSSI_MAX       127

#define     FM_STOP_RSSI_MIN        -128
#define     FM_STOP_RSSI_MAX        127
/* minimum and maximum value of start SNR for soft mute */
#define     FM_START_MUTE_MIN       0
#define     FM_START_MUTE_MAX       63
/* minimum and maximum value of ultimate mute attenuation level */
#define     FM_STOP_ATTEN_MIN       -128
#define     FM_STOP_ATTEN_MAX       127
/* minimum and maximum value of mute rate */
#define     FM_MUTE_RATE_MIN        0
#define     FM_MUTE_RATE_MAX        63
/* minimum and maximum value of SNR reading adjustment */
#define     FM_SNR40_MIN            -128
#define     FM_SNR40_MAX            127
...
struct fm_rx {
    ...
    char  curr_cos_threshold;       /* Current COS threshold value */
...
struct fm_softmute_blend_config {
    unsigned char start_snr;
    unsigned char stop_snr;
    signed char start_rssi;
    signed char stop_rssi;
    unsigned char start_mute;
    signed char stop_atten;
    unsigned char mute_rate;
    signed char snr40;
};
...
struct fmdrv_ops {
    ...
    struct fm_softmute_blend_config softmute_blend_config;  /* FM Softmute and audio blend config */
    unsigned char set_blndmute;    /* Current softmute and audio blending setting */
    struct mutex mutex;
};
#endif
