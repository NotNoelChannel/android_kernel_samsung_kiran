%define BOARD_TIZEN_KIRAN	tizen_kiran

Name: linux-3.10-sc7727
Summary: The Linux Kernel
Version: Tizen_KIRAN_20141117_1_3197d2f
Release: 1
License: GPL
...
%define BOARDS %{BOARD_TIZEN_KIRAN}
...
do
print("%package -n linux-3.10-sc7727_"..targets.." \n")
...
print("\n")
print("%files -n linux-3.10-sc7727_"..targets.." \n")
...
print("\n")
print("%post -n linux-3.10-sc7727_"..targets.." \n")
...
print("\n")
print("%description -n linux-3.10-sc7727_"..targets.." \n")
print("This package provides the sc7727_eur linux kernel image & module.img. \n")
print("\n")
print("%package -n linux-3.10-sc7727_"..targets.."-debuginfo \n")
print("License:        TO_BE_FILLED \n")
print("Summary:        Linux support headers for userspace development \n")
print("Group:          TO_BE_FILLED/TO_BE_FILLED \n")
print("\n")
print("%files -n linux-3.10-sc7727_"..targets.."-debuginfo \n")
print("/var/tmp/kernel/mod_"..targets.." \n")
print("/var/tmp/kernel/kernel-"..targets.." \n")
print("\n")
print("%description -n linux-3.10-sc7727_"..targets.."-debuginfo \n")
print("This package provides the sc7727_eur linux kernel's debugging files. \n")
end }

%package -n kernel-headers-3.10-sc7727
...
%files -n kernel-headers-3.10-sc7727
/usr/include/*

%files -n linux-kernel-license
/usr/share/license/*

%files -n kernel-devel-3.10-sc7727 -f develfiles
