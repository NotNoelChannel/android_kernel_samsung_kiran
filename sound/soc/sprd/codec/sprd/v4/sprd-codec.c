...
static int adclhpl_set(struct snd_soc_codec *codec, int on)
{
	...
	*/
	return _mixer_linein_dac_set(codec, SPRD_CODEC_ADCLHEADPHONE_L_SET,
					SOC_REG(ANA_CDC7), BIT(ADCL_P_HPL),
					on , ADCL_P_HPL);
}
...
static int adclhpr_set(struct snd_soc_codec *codec, int on)
{
	...
	*/
	return _mixer_linein_dac_set(codec, SPRD_CODEC_ADCLHEADPHONE_R_SET,
					SOC_REG(ANA_CDC7), BIT(ADCL_N_HPR),
					on , ADCL_N_HPR);
}
...
static int adcrhpl_set(struct snd_soc_codec *codec, int on)
{
	...
	*/
	return _mixer_linein_dac_set(codec, SPRD_CODEC_ADCRHEADPHONE_L_SET,
					SOC_REG(ANA_CDC7), BIT(ADCR_P_HPL),
					on , ADCR_P_HPL);
}
...
static int adcrhpr_set(struct snd_soc_codec *codec, int on)
{
	...
	*/
	return _mixer_linein_dac_set(codec, SPRD_CODEC_ADCRHEADPHONE_R_SET,
					SOC_REG(ANA_CDC7), BIT(ADCR_P_HPR),
					on , ADCR_P_HPR);
}
...
static int adclspkl_set(struct snd_soc_codec *codec, int on)
{
	...
	return snd_soc_update_bits(codec, SOC_REG(ANA_CDC6), BIT(ADCL_AOL),
				   on << ADCL_AOL);
	*/
	return _mixer_linein_dac_set(codec, SPRD_CODEC_ADCLSPEAKER_L_SET,
					SOC_REG(ANA_CDC6), BIT(ADCL_AOL),
					on , ADCL_AOL);
}
...
static int adcrspkl_set(struct snd_soc_codec *codec, int on)
{
	...
	return snd_soc_update_bits(codec, SOC_REG(ANA_CDC6), BIT(ADCR_AOL),
				   on << ADCR_AOL);
	*/
	return _mixer_linein_dac_set(codec, SPRD_CODEC_ADCRSPEAKER_L_SET,
					SOC_REG(ANA_CDC6), BIT(ADCR_AOL),
					on , ADCR_AOL);
}
...
static void sprd_codec_power_disable(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, SOC_REG(ANA_PMU0), BIT(OVP_LDO), 0);
...
#ifdef SPRD_CODEC_PGA_MAX
#undef SPRD_CODEC_PGA_MAX
#endif
