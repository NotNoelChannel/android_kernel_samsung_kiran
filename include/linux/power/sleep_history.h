...
extern void wakeupby_integer_to_char(char *char_str,int digit);
extern void wakeupby_string_add(char *str1, char *str2);
extern int set_wakeup_by_something(int ret, u32 sprd_irqs_sts[], u32 sprd_hard_irq[], char* irq_str);
