...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_TIZEN_KIRAN)
extern struct cpufreq_governor cpufreq_gov_tizen_kiran;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_tizen_kiran)
#endif
