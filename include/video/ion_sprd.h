...
#define ION_HEAP_ID_GSP		4
#ifdef CONFIG_SPRD_IOMMU
#define ION_HEAP_ID_MM_IOMMU		14
#define ION_HEAP_ID_GSP_IOMMU		15
#endif
...
#define ION_HEAP_ID_MASK_GSP		(1<<ION_HEAP_ID_GSP)
#ifdef CONFIG_SPRD_IOMMU
#define ION_HEAP_ID_MASK_GSP_IOMMU		(1<<ION_HEAP_ID_GSP_IOMMU)
#define ION_HEAP_ID_MASK_MM_IOMMU		(1<<ION_HEAP_ID_MM_IOMMU)
#endif
