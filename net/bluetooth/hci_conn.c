...
static const struct sco_param sco_param_cvsd[] = {
	{ (EDR_ESCO_MASK & ~ESCO_2EV3) | SCO_ESCO_MASK | ESCO_EV3 , 0x000a }, /* S3 */
...
static const struct sco_param sco_param_wideband[] = {
	{ (EDR_ESCO_MASK & ~ESCO_2EV3) | ESCO_EV3, 0x000d }, /* T2 */
	{ EDR_ESCO_MASK & ~ESCO_2EV3,	0x0008 }, /* T1 */
};
#else
static const struct sco_param sco_param_cvsd[] = {
...
#ifdef CONFIG_TIZEN_WIP
			else if (conn->type == LE_LINK && bacmp(&conn->dst, BDADDR_ANY))
#else
